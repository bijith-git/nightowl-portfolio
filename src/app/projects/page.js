                ...
                <div className="row justify-content-between mil-p-90-120">
                  ...
                  <div className="col-lg-6">
                    <p className="mil-up mil-mb-30">
                      ...
                      security while protecting personal privacy.The camera has
                      an open and closed mode, we define the product to have
                      clear two sides, expressing two working states and
                      emotions.
                    </p>
                    <p className="mil-up">
